...
class Interpret:
    ...
    def parse_var(self, arg):
        ...
        regex = re.compile(
            r"^TF@[a-zA-Z_\-$&%*!?]{1}[a-zA-Z0-9_\-$&%*!?]*$|^LF@[a-zA-Z_\-$&%*!?]{1}[a-zA-Z0-9_\-$&%*!?]*$|^GF@[a-zA-Z_\-$&%*!?]{1}[a-zA-Z0-9_\-$&%*!?]*$")
    ...
    def break_(self):
        ...
        print("callStack = " + str(
            self.__callStack.get_stack()) + " (These are order numbers, to which instruction will interpret RETURN)",
              file=sys.stderr)
